     ...
     <!-- <div class="col-md-3">
        <div class="panel panel-default panel-border">
            <div class="panel-heading"> 
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="panel-title">Filter Kemahasiswaan         
                    </div>
                    <div class="col-md-2">
                        <button class="btn waves-effect waves-light btn-primary btn-sm" onclick="showModal('Kemahasiswaan')"><i class="fa fa-plus"></i></button>
                    </div>
                </div>
            </div> 
...
<?php $this->load->view("bo/pages/modals/informasi/form-kategori",array("id"=>4,"name"=>"Kemahasiswaan"));?>
<script type="text/javascript">
$(document).ready(function() {
    load_data(1, {});
    load_category("Kemahasiswaan");
    set_ckeditor("desc");
...
<script src="<?= base_url() . 'assets/' ?>js/pages/kemahasiswaan.js" type="text/javascript"></script>
