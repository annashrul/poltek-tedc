                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="<?= $label ?>" id="<?=$label?>" class="form-control" rows="5" cols="50"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
...
<script src="<?= base_url() . 'assets/' ?>js/pages/testimoni.js" type="text/javascript"></script>
