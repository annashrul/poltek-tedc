            ...
            <form id="form_input" class="form-input">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <?php $label = 'id_vocational'; ?>
                                <label>Jurusan</label>
                                <select name="<?=$label?>" id="<?=$label?>" class="form-control validate[required]" ></select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="<?= $label ?>" id="<?=$label?>"></textarea>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
...
<script src="<?= base_url() . 'assets/' ?>js/pages/organisasi.js" type="text/javascript"></script>
