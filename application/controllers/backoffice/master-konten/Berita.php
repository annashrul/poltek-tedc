...
class Berita extends CI_Controller
{
                ...
                $output .='
                    <article class="postcard light blue">
                        <a class="postcard__img_link" href="#">
                            <img class="postcard__img" src="'.base_url().$row["information_image"].'" alt="Image Title" style="height:270px" />
                        </a>
    ...
    public function simpan(){
        ...
        $new_data = [
            ...
            'desc' => $_POST['desc'],
            'status' => $_POST['status'],
            'id_information_category' => $_POST['id_category'],
            'id_user' => $this->id,
            'slug' => url_title($_POST['title'], 'dash', true),
        ];
        if($_FILES['file_upload']['name'] !=""){
            $new_data["image"] = $this->M_crud->configUploads("berita",$_POST['file_uploaded'],$_FILES['file_upload'],'file_upload');
        }
