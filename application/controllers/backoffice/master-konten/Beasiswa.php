...
class Beasiswa extends CI_Controller
{
    ...
    public function simpan(){
        ...
        $new_data = [
            ...
            'desc' => $_POST['desc'],
            'status' => $_POST['status'],
            'id_information_category' => 19,
            'id_user' => $this->id,
            'slug' => url_title($_POST['title'], 'dash', true),
        ];
        if($_FILES['file_upload']['name'] !=""){
            $new_data["image"] = $this->M_crud->configUploads("beasiswa",$_POST['file_uploaded'],$_FILES['file_upload'],'file_upload');
        }
