...
function load_jabatan() {
	_ajax(base_controller+"master-data/jabatan/get_option", {id:null}, function (res) {
        $("#id_position").html(res.output)
	},false);
}
...
function edit(id) {
	...
	_ajax(`edit`, { id: id }, function (res) {
		if (res.status) {
            ...
            setTimeout(function () {
                $("#id_position").val(res.res_data["id_position"]);
